...
(
    ...
    CONSTRAINT fk_shop_category_id_items FOREIGN KEY (shop_category_id) REFERENCES cmw_shops_categories (shop_category_id) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    shop_shopping_session_id INT NOT NULL,
    shop_item_id             INT NOT NULL,
    shop_cart_item_quantity  INT NOT NULL DEFAULT 1,
    shop_cart_item_created   TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    shop_cart_item_updated   TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_shop_item_id_cart_items FOREIGN KEY (shop_item_id) REFERENCES cmw_shops_items (shop_item_id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_shop_shopping_session_id_cart_items FOREIGN KEY (shop_shopping_session_id) REFERENCES cmw_shops_shopping_session (shop_shopping_session_id) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    shop_item_requirement_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    shop_item_requirement_updated TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(
    ...
    shop_item_action_updated TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(
    ...
    user_id                     INT NOT NULL,
    shop_payment_history_type   VARCHAR(50) NOT NULL,
    shop_payment_history_status INT NOT NULL DEFAULT 0,
    CONSTRAINT fk_user_id_payment_history FOREIGN KEY (user_id) REFERENCES cmw_users (user_id) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    shop_payment_discount_created                        TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    shop_payment_discount_updated                        TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_shop_item_id_payment_discount FOREIGN KEY (shop_item_id) REFERENCES cmw_shops_items (shop_item_id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_shop_category_id_payment_discount FOREIGN KEY (shop_category_id) REFERENCES cmw_shops_categories (shop_category_id) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    user_id                  INT NOT NULL,
    shop_item_id             INT NOT NULL,
    parent_shop_order_id     INT NULL,
    shop_order_quantity      INT NULL,
    shop_order_total         FLOAT(10,2) NULL,
    shop_order_status        INT NOT NULL DEFAULT 1,
    shop_payment_discount_id INT NULL,
    shop_order_created       TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    shop_order_updated       TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_user_id_orders FOREIGN KEY (user_id) REFERENCES cmw_users (user_id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_shop_item_id_orders FOREIGN KEY (shop_item_id) REFERENCES cmw_shops_items (shop_item_id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_shop_order_id_orders FOREIGN KEY (parent_shop_order_id) REFERENCES cmw_shops_orders (shop_order_id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_shop_payment_discount_id_orders FOREIGN KEY (shop_payment_discount_id) REFERENCES cmw_shops_payment_discount (shop_payment_discount_id) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    shop_delivery_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    shop_delivery_updated TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_user_id_delivery FOREIGN KEY (user_id) REFERENCES cmw_users (user_id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_shop_item_id_delivery FOREIGN KEY (shop_item_id) REFERENCES cmw_shops_items (shop_item_id) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_shop_order_id_delivery FOREIGN KEY (shop_order_id) REFERENCES cmw_shops_orders (shop_order_id) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    shop_delivery_user_address_created     TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    shop_delivery_user_address_updated     TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_user_id_delivery_user_address FOREIGN KEY (user_id) REFERENCES cmw_users (user_id) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
