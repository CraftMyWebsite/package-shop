        ...
        'elements' => [
            'global' => [
                ...
                'mailNotification' => [
                    ...
                    'alert-1' => 'Ces notifications servent à envoyer des mails aux utilisateurs pour les tenir informer de :',
                    'alert-2' => '- Envoyer le récapitulatif de commandes',
                    'alert-3' => '- L\'état d\'avancement de leurs commandes (En cours, Traité, Irréalisable ...)',
                    'alert-4' => '- L\'état sur des articles dans leurs paniers (Hors stock, Changé ...)',
                    'mail' => 'Paramétrage du mail :',
                    'show-name' => 'Afficher le nom du site ?',
                    'no' => 'Non',
                    'yes' => 'Oui',
                    'show-logo' => 'Afficher le logo ?',
                    'logo' => 'Logo (url) :',
                    'use-header' => 'Utiliser l\'en tête personnalisée ?',
                    'header' => 'En tête personnalisée :',
                    'use-footer' => 'Utiliser le pied de page personnalisée ?',
                    'footer' => 'Pied de page personnalisée :',
                    'use-footer-2' => 'Utiliser le footer ?',
                    'footer-label' => 'Footer :',
                    'footer-default' => ' - Merci de votre confiance et à bientôt sur notre site !',
                    'preview' => 'Aperçu du mail :',
                    'title' => 'Titre de notification',
                    'info' => '>>> Le texte de la notification sera automatiquement insérer à cet emplacement. <<<',
                    'appearances' => 'Apparences :',
                    'font' => 'Police d\'écriture :',
                    'back' => 'Couleur du fond',
                    'container' => 'Couleur du conteneur',
                    'header-color' => 'Couleur de l\'en tête',
                    'text-color' => 'Couleur des textes',
                    'title-color' => 'Couleur du titre',
                ...
                'reviewReminder' => [
                    'name' => 'Relance Avis',
                    'object' => 'Objet du mail :',
                    'object-default' => ' - Votre avis nous intéresse !',
                    'mail' => 'Paramétrage du mail :',
                    'title' => 'Titre :',
                    'title-default' => 'Votre avis nous intéresse !',
                    'message' => 'Message :',
                    'message-default' => 'Vous avez récemment commander un article sur notre boutique.',
                    'footer-1' => 'Message footer 1 :',
                    'footer-1-default' => 'Nous aimerions savoir ce que vous pensez de cet article',
                    'footer-2' => 'Message footer 2 :',
                    'footer-2-default' => 'Rendez-vous sur la boutique pour partager votre avis',
                    'preview' => 'Aperçu du mail :',
                    'appearances' => 'Apparences :',
                    'back' => 'Couleur du fond',
                    'card' => 'Couleur du fond du cadre',
                ...
                'withdrawPointMap' => [
                    'name' => 'Carte point retrait',
                    'use' => 'Utiliser la carte interactive',
                    'yes' => 'Oui',
                    'no' => 'Non',
                    'popup' => 'Nom de l\'adresse du client dans le popup :',
                    'popup-default' => 'Votre adresse',
                    'map' => 'Style de la carte',
                    'simplistic' => 'Simpliste',
                    'simplistic+' => 'Simpliste détaillé',
                    'satellite' => 'Satellite',
                    'appearances' => 'Apparences :',
                    'client-icon' => 'Icône du client',
                    'client-icon-color' => 'Couleur de l\'icône client',
                    'back-icon' => 'Fond de l\'icône',
                    'depot-icon' => 'Icône des dépôts',
                    'depot-icon-color' => 'Couleur de l\'icône depôt',
                    'depot-back' => 'Fond de l\'icône depôt',
                    'result' => 'Résultat :',
                ],
            ],
            'payments' => [
            ...
            'virtual' => [
                ...
                'download' => [
                    'name' => 'Téléchargeable',
                    'desc' => 'Permet à vos utilisateurs de télécharger tout type de documents, pour augmenter la taille de transfert des fichiers merci de modifier votre php.ini <div class=\'alert-warning\'> <b>Attention !</b> Ceci n\'est pas encore fonctionnel !</div>',
                ],
                'giftCode' => [
                    'name' => 'Carte cadeau',
